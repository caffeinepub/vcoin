...
export class Backend implements backendInterface {
    ...
    async createDepositIntent(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createDepositIntent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerDepositIntents(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerDepositIntents();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerDepositSubmissions(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerDepositSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentPresaleStage(): Promise<{
        stage: bigint;
        price: number;
        remainingSupply: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentPresaleStage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDepositIntent(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDepositIntent(arg0);
    ...
    async getDepositSubmission(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDepositSubmission(arg0);
                return from_candid_opt_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDeposit(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDeposit(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserProfile(arg0: Principal, arg1: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserProfile(arg0, to_candid_UserProfile_n18(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
